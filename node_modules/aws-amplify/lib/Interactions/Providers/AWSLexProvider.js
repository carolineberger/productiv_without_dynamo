                                ...
                                if (err) {
                                    ...
                                    if (data.dialogState === 'ReadyForFulfillment') {
                                        ...
                                        if (typeof _this._botsCompleteCallback[botname] === 'function') {
                                            _this._botsCompleteCallback[botname](null, { slots: data.slots });
                                        }
                                        if (_this._config && typeof _this._config[botname].onComplete === 'function') {
                                            _this._config[botname].onComplete(null, { slots: data.slots });
                                        }
                                    }
                                    if (data.dialogState === 'Failed') {
                                        if (typeof _this._botsCompleteCallback[botname] === 'function') {
                                            _this._botsCompleteCallback[botname]({ err: 'Bot conversation failed' });
                                        }
                                        if (_this._config && typeof _this._config[botname].onComplete === 'function') {
                                            _this._config[botname].onComplete('Bot conversation failed');
                                        }
                                    }
                                    res(data);
                                }
